  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 z-0">
        ...
        {/* Background Image (desktop only for clarity) */}
        <div
        ...
        {/* Gradient Overlay */}
        <div className="absolute inset-0 bg-gradient-to-r from-slate-50 via-slate-50/95 to-slate-50/60" />
      </div>
      ...
      <div className="container mx-auto px-4 relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        ...
        >
          ...
          <p className="text-xl text-slate-600 mb-8 max-w-xl leading-relaxed">
            We design and engineer secure, scalable websites and mobile
            applications — built for performance, reliability, and long-term
            growth.
          </p>
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            <Link
              to="/portfolio"
              className="px-8 py-4 rounded-full font-semibold text-lg text-slate-700 border border-slate-300 hover:bg-slate-100/60 hover:border-slate-400 transition-all flex items-center justify-center backdrop-blur-sm"
            >
              View Our Work
            </Link>
          </div>
        ...
        >
          <div className="relative">
            <div className="absolute -inset-1 bg-gradient-to-r from-blue-500 to-violet-500 rounded-2xl blur opacity-25" />
            ...
            {/* Floating Badge */}
            <div className="absolute -bottom-10 -left-10 bg-white/90 backdrop-blur-md p-6 rounded-2xl border border-slate-200 shadow-xl animate-float">
